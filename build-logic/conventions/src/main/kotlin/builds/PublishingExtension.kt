...
private fun Project.configurePublish(
  ...
  extensions.configure(MavenPublishBaseExtension::class.java) { extension ->
    ...
    extension.pom { mavenPom ->
      ...
      mavenPom.url.set("https://www.github.com/rbusarow/ktlint/")
      ...
      mavenPom.scm { scm ->
        scm.url.set("https://www.github.com/rbusarow/ktlint/")
        scm.connection.set("scm:git:git://github.com/rbusarow/ktlint.git")
        scm.developerConnection.set("scm:git:ssh://git@github.com/rbusarow/ktlint.git")
      }
