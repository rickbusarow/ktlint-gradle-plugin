 ...
 * @property group The maven "group", which should always be `com.rickbusarow.ktlint`. This is the
 ...
 * @property javaVersion the java version of the artifact (typically 8 or 11). If not set explicitly,
