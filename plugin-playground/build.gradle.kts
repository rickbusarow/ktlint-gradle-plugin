...
ktlint {
  ...
  docSet("main") {
    ...
    sampleCodeSource("../ktlint-gradle-plugin/src/main/kotlin")
    ...
    rule("code") {
      ...
      replacement = sourceCode(
        fqName = "com.rickbusarow.ktlint.gradle.ktlintTask",
        bodyOnly = true,
  ...
  doLast {
    ...
    repeat(5) { i ->
      repeat(5) { j ->
        ...
        <!--ktlint cats-to-dogs,dogs-to-cats-->
...
tasks.withType(com.rickbusarow.ktlint.gradle.ktlintTask::class.java) {
